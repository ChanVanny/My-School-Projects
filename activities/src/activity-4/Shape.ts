...
class Line {
  ...
  translate(x: number, y: number): Line {
    // TODO create a new line translated of (x, y)
    const translatedPoint1 = this.point1.translate(x, y);
    const translatedPoint2 = this.point2.translate(x, y);
    return new Line(translatedPoint1, translatedPoint2, this.color);
  }
}
